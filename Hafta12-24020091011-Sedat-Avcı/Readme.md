...
3. **Soru 3 (`Bolum14-3`)**: 1–11 arasından **rastgele 3 görsel/taş** seçip yan yana gösterir.
4. **Soru 4 (`Bolum14-4`)**: Bir çember etrafına saat düzeninde **karakter/sayıları** ("3 4 5 ... 1 2") yerleştirir.
5. **Soru 5 (`Bolum14-5`)**: JavaFX ile **8x8 satranç tahtası** (siyah-beyaz kareler) çizer.
6. **Soru 6 (`Bolum14-6`)**: **52 iskambil kartı görsellerini** GridPane üzerinde ızgara şeklinde listeler.
7. **Soru 7 (`Bolum14-7`)**: Ekrana 5 adet **"Java"** yazısı basar; her birini **rastgele renk ve saydamlık** (opacity) ile gösterir.
